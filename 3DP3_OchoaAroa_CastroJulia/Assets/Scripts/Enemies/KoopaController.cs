...
public class KoopaController : StateMachine<EKoopaState>, IRestartGameElement
{
    ...
    protected override BState<EKoopaState> CreateInitialState()
    {
        return new KPatrolState(this, m_NavMeshAgent, m_PatrolPositions, m_MinDistanceToAlert);
    }
